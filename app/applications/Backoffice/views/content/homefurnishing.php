...
<div class="row" style="margin-bottom:20px">
    ...
    <tr>
    <td><textarea class='summernote form-form-control' id='summernote' name=content><?php echo $data['content'] ?></textarea></td>
    </tr>
    ...
    <td><img src = '<?php echo URLROOT. '/uploads/'.$data['picture']  ?>'  height=200px width=800px /></td>
    </tr>

    <tr>
    <td><button style='font-size:12px' name='savefurnishing' class='btn btn-warning'> Submit</button></td>
    </tr>
