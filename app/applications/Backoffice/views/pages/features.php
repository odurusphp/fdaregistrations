...
.form-control{
  ...
  <div class="container-fluid main_container" style='margin-top:-10px'>
      ...
      <div class="row">
        <div class="col-12">
          <h1 style='color:#800080; font-weight:700' class="page-title"> ADD FEATURES </h1>
        </div>
   </div>
...
<div class="row" style="margin-bottom:20px">  
     ...
     padding:5px; width:200px; margin-left:10px; color:#800080'>Add New Features</legend>
      ...
      <tr>
       <td></td>
       <td><button class='btn btn-danger' type='submit' name='addfeature' > Add</button></td>
      </tr>
      ...
      <table  class='table table-bordered table-condensed table-striped apptables' style='font-size:12px'>
       ...
       ?>
       <tr>
       <td><?php  echo $get->featurename  ?></td>
       <td><a href='#'<i class='fa fa-pencil'></i></a></td>
       <td><a href='#' class='features' featureid='<?php echo $get->fid  ?>'><i class='fa fa-trash'></i></a></td>
