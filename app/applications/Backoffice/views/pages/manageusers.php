...
.form-control{
  ...
  <div class="container-fluid main_container" style='margin-top:-10px'>
      ...
      <div class="row">
        <div class="col-12">
          <h1 style='color:#F98903; font-weight:700' class="page-title">MANAGE USERS</h1>
        </div>
   </div>
...
<div class="row" style="margin-bottom:20px">
      ...
      <table  class='table table-bordered table-condensed apptables' style='font-size:12px'>
       ...
       <td><a href='<?php echo URLROOT.'/backoffice/pages/editusers/'.$get->uid  ?>' ><i class='fa fa-pencil'></i></a></td>
       <td><a href='#' userid ='<?php  echo $get->uid ?>'  class='deleteuser'><i class='fa fa-trash'></i></a></td>
      </tr>
       <?php
       endforeach;
       ?>
